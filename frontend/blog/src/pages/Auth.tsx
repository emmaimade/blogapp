...
export const AuthPage: React.FC = () => {
 ...
 i < getCurrentStepNumber() ? 'bg-zinc-900' : 'bg-zinc-200'
 }`}
                    ></div>
                  ))}
                </div>
          ...
          {step === 'email' && (
            <form onSubmit={handleEmailSubmit} className="space-y-6">
              ...
              <button 
                type="submit"
                className="w-full bg-primary text-white py-3 rounded-xl font-bold hover:bg-purple-700 transition-all shadow-lg shadow-purple-900/10 hover:shadow-xl flex items-center justify-center gap-2"
              >
                Continue
                <ArrowRight size={20} />
              </button>
              ...
              <div className="grid grid-cols-2 gap-3">
                <button type="button" className="flex items-center justify-center gap-2 py-3 px-4 bg-zinc-50 hover:bg-zinc-100 rounded-xl font-medium text-zinc-700 transition-all">
            ...
            <form onSubmit={handlePasswordSubmit} className="space-y-6">
              ...
              {mode === 'login' && (
                <div className="text-right">
                  <a href="#" className="text-sm text-zinc-900 hover:text-zinc-950 font-medium">
                    Forgot password?
                  </a>
                </div>
              )}
              ...
              <button 
                type="submit"
                disabled={isLoading}
                className="w-full bg-primary text-white py-3 rounded-xl font-bold hover:bg-purple-700 transition-all shadow-lg shadow-purple-900/10 hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isLoading ? (
        ...
        <p className="mt-8 text-center text-xs text-zinc-500">
          ...
          <a href="/terms" className="text-zinc-900 hover:underline">Terms of Service</a>
          {' '}and{' '}
